...
ThemeData nitronTheme() => ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: const Color(0xFF141A23),
...
class _LogoPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final a = Path()
      ..moveTo(size.width * .12, size.height * .76)
      ..lineTo(size.width * .43, size.height * .12)
      ..quadraticBezierTo(size.width * .48, size.height * .04, size.width * .56, size.height * .19)
      ..lineTo(size.width * .66, size.height * .37)
      ..lineTo(size.width * .47, size.height * .77)
      ..lineTo(size.width * .22, size.height * .88)
      ..quadraticBezierTo(size.width * .07, size.height * .94, size.width * .12, size.height * .76)
      ..close();
    final b = Path()
      ..moveTo(size.width * .88, size.height * .24)
      ..lineTo(size.width * .57, size.height * .88)
      ..quadraticBezierTo(size.width * .52, size.height * .96, size.width * .44, size.height * .81)
      ..lineTo(size.width * .34, size.height * .63)
      ..lineTo(size.width * .53, size.height * .23)
      ..lineTo(size.width * .78, size.height * .12)
      ..quadraticBezierTo(size.width * .93, size.height * .06, size.width * .88, size.height * .24)
      ..close();
    canvas.drawPath(
      a,
      Paint()
        ..shader = const LinearGradient(
          colors: [Color(0xFFE3F8FF), Color(0xFF69D1F2), Color(0xFF3F7892)],
    ...
    canvas.drawPath(
      ...
      Paint()
        ..shader = const LinearGradient(
          colors: [Colors.white, Color(0xFFA9DFF4), Color(0xFF46798F)],
        ).createShader(Offset.zero & size),
    );
  }
...
class RoundButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SizedBox.square(
        ...
        child: Material(
          ...
          child: InkWell(
            onTap: onTap,
            child: Icon(icon, size: 19, color: const Color(0xFFB3BCC9)),
          ),
        ),
      );
}
